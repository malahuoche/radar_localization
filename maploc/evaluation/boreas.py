...
# from ..data import BoreasDataDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": BoreasDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": BoreasDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = BoreasDataModule(cfg.get("data", {}))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment", type=str, default="OrienterNet_MGL_kitti_1028_2",required=True)
    parser.add_argument(
