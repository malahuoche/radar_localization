import os
import re
directory_path = "/home/classlab2/16T/datasets/boreas./boreas-2021-03-02-13-38/cart"
...
output_file_path = os.path.join(base_directory,'boreas-2021-03-02-13-38', 'matched_timestamp.txt')
camera_timestamp_file = os.path.join(base_directory, 'boreas-2021-03-02-13-38', 'camera_timestamp.txt')
camera_timestamps = []
